...
{
	/**
	 * @see MailIntegrationDAO#add(MailIntegration)
	 */
	...
	/**
	 * @see MailIntegrationDAO#delete(int)
	 */
	...
	/**
	 * @see MailIntegrationDAO#find(int)
	 */
	...
	/**
	 * @see MailIntegrationDAO#findAll()
	 */
	public List findAll()
	{
	...
	/**
	 * @see MailIntegrationDAO#update(MailIntegration)
	 */
