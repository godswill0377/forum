...
UserModel.addNew = INSERT INTO jforum_users (username, user_password, user_email, user_regdate, user_actkey, rank_id, apiKey) VALUES (?, ?, ?, ?, ?, 0, ?)
...
UserModel.selectByApiKey = SELECT * FROM jforum_users WHERE LOWER(apiKey) = LOWER(?)
